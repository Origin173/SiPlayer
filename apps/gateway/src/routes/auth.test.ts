...
const provider: ContentProvider = {
  ...
  getAlbum: async () => ({ id: 'album-1', name: 'Album', artists: [], tracks: [] }),
  getArtist: async () => ({ id: 'artist-1', name: 'Artist' }),
  getArtistTopTracks: async () => [],
  getArtistAlbums: async () => ({ items: [], page: 1, pageSize: 30, hasMore: false }),
